  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomMenu(
        changePage: (page) {
          setState(() {
            // _currentPage = page; //aca es redundante ahora mismo porque el animateToPage se encarga de que la pagina del PageView cambie y entonces en su PageView.builder la propiedad onPageChanged recibe el indice de la pagina a la que va y esta haciendo un setState al _currentPage por lo tanto se redibuja el builder y se pasa el nuevo _currentPage
